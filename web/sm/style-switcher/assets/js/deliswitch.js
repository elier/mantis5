...
jQuery(document).ready(function($) {
	...
	var skinLogoDefault = '/mantis5/web/sm/img/mantis5-logo-white.png';
	...
	$('.switch-skin, .switch-skin-full').click( function(e) {
		...
		if($(this).hasClass('fullbright')) {
			skinLogo = '/mantis5/web/sm/img/mantis5-logo.png';			
		}else {
	...
	function resetStyle() {
		...
		$('.logo img').attr('src', '/mantis5/web/sm/img/mantis5-logo-white.png');
